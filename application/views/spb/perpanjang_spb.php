...
link_js('jquery_terbilang.js,zetro_number.js,perpanjang_spb.js','asset/js,asset/js,application/views/spb/js');
$user_aktiv=$this->session->userdata("userid");
$bln="<select id='bulan'></select>";
$thn="<select id='thn'></select>";
panel_begin('Perpanjang SPB','frm1');
...
<?
popup_start('Process Document','350','180','frm5');
?><br />
<table style='border-collapse:collapse' width='95%' align='center'>
  <tr><td width='50%' class='b_line'>Tindakan :&nbsp;</td><td width='50%'>
	 ...
	 <option value=''>&nbsp;</option>
	 <option value='Y'>Perpanjang</Option>
	 <option value='N'>Tidak</Option></select></td></tr>
  <tr id='hrg' style='display:none'><td class='b_line'> Jumlah pembayaran : &nbsp;</td><td>
	 <input id='bayar' name='bayar' type='text' class='angka' value='0'><div id='terbilang'></div></td></tr>
