...
link_js('zetro_number.js,lap_nasabah.js','asset/js,application/views/laporan/js');
$tahun="<select id='thn' name='thn'></select>";
panel_begin('Jumlah Nasabah,Nilai Taksir','','Grafik Tahun : ,'.$tahun);
$zb=new zetro_listBuilder('asset/bin/zetro_form.cfg');
panel_multi('jumlahnasabah',true);
?>
<div id='chartdiv'></div>
