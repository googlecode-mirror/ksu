...
<select id='oto_usernm' name='oto_usernm'></select>\n <hr>";
$zb=new zetro_listBuilder('asset/bin/form.cfg');
...
<div id='lvladd'  style='display:none; border:5px solid #333; padding:0px; left:0; top:0; width:280px; max-height:300px; position:fixed; overflow:auto'>
